...
const InsertSaleItem = () => {
    ...
    const [saleItemName, setSaleItemNameFunc] = useState(null);
            ...
            <CContainer>
                <CForm>
                    <CInputGroup className="mb-2">
                        <CInputGroupText className="col-sm-4">
                            Product
                        </CInputGroupText>
                        <CFormInput
                        ...
                        >
                            ...
                            <CModalBody>
                                <ProductsTable
                                    item={citem}
                                    editItem={updateEditVisibility}
                                    setSaleItemName={setSaleItemNameFunc}
                                ></ProductsTable>
                            </CModalBody>
                            <CModalFooter className="d-flex justify-content-around">
                                <CButton
                                    color="primary"
                                    onClick={() => setModalAvailability(false)}
                                >
                                    Insert
                                </CButton>
                                {/* <CButton
              ...
              ></Autocomplete>
                ...
                <div className="container d-flex flex-row justify-content-center mx-1 mb-4">
                    <CButton
                        ...
                        onClick={() => {
                            console.log("start")
                            console.log(productFieldsInput);
                            updateProductFieldsInput((previousData) => {
                                return {
                                    ...previousData,
                                    ['pname']: saleItemName.product_name,
                                    ['unitrate']: saleItemName.retail_price,
                                };
                            });
                            console.log("end")
                            console.log(productFieldsInput);
