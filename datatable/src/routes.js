...
const customerDatatable = React.lazy(
    () => import("./views/posProduct/customerDatatable"),
);
const salePOS = React.lazy(() => import("./views/posProduct/salePOS"));
const salesDatatable = React.lazy(
    () => import("./views/posProduct/salesDatatable"),
);
const settleSale = React.lazy(() => import("./views/posProduct/settleSale"));
// const Vendors = React.lazy(() => import("./views/posProduct/Vendors"));
const VendorsDatatable = React.lazy(
    () => import("./views/posProduct/VendorDatatable"),
);
...
const routes = [
    ...
    { path: "/vendors", name: "Vendors", element: VendorsDatatable },
    // { path: '/addnewproduct', name: 'Add Product', element: Products },
    // {path:'',name:'',element:},
